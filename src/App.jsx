...
const DEFAULT_COLORS = {
  main: "#3e3226",    // 焦げ茶（ヘッダー、見出し）
  accent: "#ca9e45",  // 金（ボタン、選択枠）
  bg: "#e8e2d2"       // ベージュ（背景）
};
  ...
  return (
    <div className="page">
          ...
          <div className="adminField">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '5px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                {/* ★管理画面の枠線もテーマカラーに連動させて、変更がわかりやすく */}
      ...
      <div className="layout">
              ...
              <div key={m.id} className="listRowCompact" style={{ flexDirection: 'column', height: 'auto', padding: '8px', gap: '5px' }}>
                <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div className="listBtnsCompact">
                    {/* ★修正：ボタン色はCSSのクラス（.ok .maybe .no）に任せ、テーマカラーで上書きしない */}
        ...
        {/* ★フォーメーションエリア：背景カラー・アクセントカラー・メインカラー適用 */}
